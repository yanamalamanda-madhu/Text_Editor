...
// Adding action listeners to menu items
        About.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(null, "<html><head><h1><b><i>Text Editor</i></b></h1></head><body><b>This Text Editor is like Notepad</b> <br/><b>This is only for creating new document<br/>editing the existed document <br/>saving the created document  </b></body></html>");
            }
        });
